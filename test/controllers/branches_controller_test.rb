...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference("Branch.count") do
      post branches_url, params: { branch: { direction: @branch.direction, name: @branch.name, telephone: @branch.telephone } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { direction: @branch.direction, name: @branch.name, telephone: @branch.telephone } }
